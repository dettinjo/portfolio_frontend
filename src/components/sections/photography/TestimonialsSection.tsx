...
// 1. The unused 'cn' import has been removed.

// ... (Interfaces and Props remain the same)
  ...
  return (
    <section id="testimonials">
      <div className="mb-12 text-center">
        ...
        {/* The apostrophe in "I've" is now correctly escaped. */}
      ...
      <div className="flex flex-col gap-8 max-w-2xl mx-auto">
        {testimonials.map((item, index) => {
          ...
          return (
            <TestimonialDialog key={index} testimonial={item}>
